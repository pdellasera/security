...
const Layout: React.FC<LayoutProps> = ({ children }) => {
    ...
    const [activePage, setActivePage] = useState<"cameras" | "alerts">("alerts")
                ...
                <div className="bg-[#0A1A40] shadow-sm z-10 text-white">
                    <div className="flex items-center px-4 py-3">
                        ...
                        <nav className="flex items-center ml-6 gap-6">
                            <a
                                href="#"
                                className={`${activePage === "cameras" ? "text-[#7FFF00] font-medium border-b-2 border-[#7FFF00] pb-2" : "text-gray-300 hover:text-white"} text-sm transition-colors duration-200`}
                                onClick={(e) => {
                                    e.preventDefault()
